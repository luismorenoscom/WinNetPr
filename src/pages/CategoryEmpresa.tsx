...
const documentosBase: Documento[] = [
  {
    nombre: "Contrato Laboral 2025.pdf",
    fecha: "2024-02-15",
    tamaño: "450 KB",
    ruta: "/assets/pruebas.pdf",
  },
  {
    nombre: "Acta de Constitución 2024.pdf",
    fecha: "2024-03-01",
    tamaño: "1.2 MB",
    ruta: "/assets/pruebas.pdf",
  },
  {
    nombre: "Informe de Actividades 2024.pdf",
    fecha: "2024-03-20",
    tamaño: "760 KB",
    ruta: "/assets/pruebas.pdf",
  },
  {
    nombre: "Estado Financiero 2023.pdf",
    fecha: "2024-04-05",
    tamaño: "980 KB",
    ruta: "/assets/pruebas.pdf",
  },
                ...
                <tbody className="divide-y">
                  {sortedDocs.map((doc, index) => (
                    <tr key={index} className="hover:bg-gray-50 transition-colors">
                      <td className="px-4 py-3 font-medium w-[35%] break-words whitespace-normal">
                        {doc.nombre}
                      </td>
...
export default CategoryEmpresa;
