...
const documentosBase: Documento[] = [
  {
    nombre: "Certificado de Nacimiento Enero.pdf",
    fecha: "2024-01-20",
    tamaño: "120 KB",
    ruta: "/assets/pruebas.pdf",
  },
  {
    nombre: "Vacunas de los Niños Abril.pdf",
    fecha: "2024-02-28",
    tamaño: "200 KB",
    ruta: "/assets/pruebas.pdf",
  },
  {
    nombre: "Póliza de Seguro Familiar Diciembre.pdf",
    fecha: "2024-03-15",
    tamaño: "290 KB",
    ruta: "/assets/pruebas.pdf",
  },
  {
    nombre: "Cita Médica Pediatra Marzo.pdf",
    fecha: "2024-04-03",
    tamaño: "175 KB",
    ruta: "/assets/pruebas.pdf",
  },
                ...
                <tbody className="divide-y">
                  {sortedDocs.map((doc, index) => (
                    <tr key={index} className="hover:bg-gray-50 transition-colors">
                      <td className="px-4 py-3 font-medium w-[35%] whitespace-normal">{doc.nombre}</td>
...
export default CategoryFamilia;
