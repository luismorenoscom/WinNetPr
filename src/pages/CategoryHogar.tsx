...
const documentosBase: Documento[] = [
  {
    nombre: "Factura de Electricidad 2025.pdf",
    fecha: "2024-01-10",
    tamaño: "210 KB",
    ruta: "/assets/pruebas.pdf",
  },
  {
    nombre: "Contrato de Alquiler 2025.pdf",
    fecha: "2024-03-01",
    tamaño: "320 KB",
    ruta: "/assets/pruebas.pdf",
  },
  {
    nombre: "Inventario del Hogar 2025.pdf",
    fecha: "2024-02-12",
    tamaño: "150 KB",
    ruta: "/assets/pruebas.pdf",
  },
  {
    nombre: "Mantenimiento del Aire Acondicionado 2025.pdf",
    fecha: "2024-04-05",
    tamaño: "275 KB",
    ruta: "/assets/pruebas.pdf",
  },
                ...
                <tbody className="divide-y">
                  {sortedDocs.map((doc, index) => (
                    <tr key={index} className="hover:bg-gray-50 transition-colors">
                      <td className="px-4 py-3 font-medium w-[35%] whitespace-normal break-words">
                        {doc.nombre}
                      </td>
